...
Ported to master from phase7-local 40d132e.

WHY THIS FILE EXISTS. The suite otherwise drives `TestClient` SERIALLY, so it is
...
ML-DSA signature rejected 153 of 320 (71-88 of 160 on master) — while the same signature passed serially
